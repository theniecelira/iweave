              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                        child: Text(weaver.name, style: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w800)),
                      ),
                      Container(
                        ...
                        child: Text('${weaver.yearsOfExperience} yrs', style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w700)),
                      ),
                    ],
                  ),
                ),
            ...
            child: Column(
              ...
              children: [
                Row(children: [
                  ...
                  Text(weaver.specialty, style: const TextStyle(fontSize: 13, color: AppColors.accent, fontWeight: FontWeight.w600)),
                  const Spacer(),
                  Row(children: [
                    const Icon(Icons.star_rounded, size: 14, color: AppColors.star),
                    const SizedBox(width: 4),
                    Text('${weaver.rating} (${weaver.reviewCount})', style: const TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                  ]),
                ]),
                const SizedBox(height: 10),
                Text(weaver.bio, style: const TextStyle(fontSize: 13, color: AppColors.textSecondary, height: 1.6), maxLines: 3, overflow: TextOverflow.ellipsis),
                const SizedBox(height: 12),
                Row(children: [
                  const Icon(Icons.location_on_rounded, size: 14, color: AppColors.textHint),
                  const SizedBox(width: 4),
                  Text(weaver.location, style: const TextStyle(fontSize: 12, color: AppColors.textHint)),
                  const Spacer(),
                  OutlinedButton(
                    onPressed: () {},
